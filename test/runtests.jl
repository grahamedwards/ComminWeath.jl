...
@testset "ComminWeath Maths" begin
    ...
    @test cwtest.A234 ≈ [1.0000000000000002, 1.0251339419215337, 1.0429833148001237, 1.0556297320347556, 1.0645601379849647]
    @test cwtest.A230 ≈ [1.0, 1.1286220296344835, 1.1435675313792528, 1.14775941670817, 1.1500365128307493] 
    ...
    @test testdate.A234 ≈ 1.0805715992678397
    @test testdate.A230 ≈ 1.1516256122565465
    @test testdate.cU ≈ 206.981674931185

    testdates = drawdates([500,1000],cwtest)
    @test testdates.A234 ≈ [1.0661450256423242, 1.0805715992678397]
    @test testdates.A230 ≈ [1.1486323697405745, 1.1516256122565465]
...
@testset "Visualization Prep" begin
    ...
    @test calcslopes([100,600,1200]) ≈ [0.2562089878418999, 0.4858696880694676, 0.5647976467037318]
